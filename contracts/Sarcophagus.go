...
//
// Solidity: function sarcophagus(bytes32 doubleHash) view returns(uint8 state, address archaeologist, bytes archaeologistPublicKey, uint256 resurrectionTime, uint256 resurrectionWindow, string name, string assetId, uint256 storageFee)
