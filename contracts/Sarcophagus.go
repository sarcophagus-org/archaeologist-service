...
//
// Solidity: function sarcophagus(bytes32 doubleHash) view returns(uint8 state, address archaeologist, uint256 resurrectionTime, uint256 resurrectionWindow, string assetId, uint256 storageFee)
